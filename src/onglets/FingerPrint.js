...
const FingerPrint = (props) => {
    let Finger_Control_chara;

    props.allCharacteristics.map(element => {
        switch (element.characteristic.uuid) {
            case "d973f2e1-b19e-11e2-9e96-0800200c9a66":
              Finger_Control_chara = element;
            break;
            case "0000fec1-8e22-4541-9d4c-21edae82ed19":
              Finger_Control_chara = element;
            break;
    ...
    async function onMonitoringButtonClick() {
        let notifStatus = document.getElementById('monitorButton').innerHTML;

        if (notifStatus === "Monitoring OFF") {
          console.log('Monitoring ON');
          //Start Anomaly and status Notif
          Finger_Control_chara.characteristic.startNotifications();
          Finger_Control_chara.characteristic.oncharacteristicvaluechanged = notifMonitoringHandler;
          document.getElementById('monitorButton').innerHTML = "Monitoring ON"
          createLogElement(Finger_Control_chara, 3, "Finger Control ENABLE NOTIFICATION ");
        } else {
          //Stop Notif
          Finger_Control_chara.characteristic.stopNotifications();
          console.log('Monitoring OFF');
          document.getElementById('monitorButton').innerHTML = "Monitoring OFF"
          createLogElement(Finger_Control_chara, 3, "Finger Control DISABLE NOTIFICATION ");
        }
    }


    //Status handler
    function notifMonitoringHandler(event){
        console.log("Notification received");
        var buf = new Uint8Array(event.target.value.buffer);
        console.log(buf);

        var icon = document.getElementById("fingericon");
        ...
        if (buf[0] == 0) {
            if(buf[1] == 0x0){
                ...
                // Change icon color
                //if(window.getComputedStyle(icon).getPropertyValue('fill') === 'rgb(0, 255, 0)'){
                //    icon.style.fill = "black";
                //}else{
                icon.style.fill = 'rgb(0, 255, 0)';
                // Return Back in 3sec
                ...
                //if(window.getComputedStyle(icon).getPropertyValue('fill') === 'rgb(255, 0, 0)'){
                //    icon.style.fill = "black";
                //}else{
                icon.style.fill = "red";
                setTimeout(() => {
          ...
          <div className="container">
            <div className="row justify-content-center mt-3">
              <div className="d-grid col-xs-6 col-sm-6 col-md-4 col-lg-4 m-2">
                <div className="d-flex flex-row">
                  <button className="defaultButton w-100" type="button" onClick={onMonitoringButtonClick} id="monitorButton">Monitoring OFF</button>
                  <span>
                    <OverlayTrigger
                      trigger={["hover", "focus"]}
                      placement="bottom"
                      overlay={popoverMonitoringButton}
                    >
            ...
            <div className="row justify-content-center mt-5">
              <div className="col-xs-6 col-sm-6 col-md-4 col-lg-4 m-2">
                    <svg id="fingericon" viewBox="0 0 1645 1646" overflow="visible">
