        ...
        <div className="container-fluid">
            <div className="container">
                ...
                <div className="form-group">
                    ...
                    <div id="file-status">Upload selected image file</div>
                        ...
                        <tr>
                        {
                            targetImageList[index].map(current_image =>
                                ...
                                >
                                    ...
                                    <h2><span class={current_image.statusClass}> {current_image.currentImageStatus} Slot  </span></h2>
